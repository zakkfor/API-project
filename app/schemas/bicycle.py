...
class BicycleBase(BaseModel):
    """Базова схема велосипеда"""
    name: str = Field(..., min_length=1, max_length=100)
    brand: str = Field(..., min_length=1, max_length=100)
    model: str = Field(..., min_length=1, max_length=100)
    type: str = Field(..., pattern="^(mountain|city|road|bmx|electric)$")
...
class BicycleCreate(BicycleBase):
    """Схема для створення велосипеда"""


class BicycleUpdate(BaseModel):
    """Схема для оновлення велосипеда"""
    name: Optional[str] = Field(None, min_length=1, max_length=100)
    brand: Optional[str] = Field(None, min_length=1, max_length=100)
    model: Optional[str] = Field(None, min_length=1, max_length=100)
    type: Optional[str] = Field(None, pattern="^(mountain|city|road|bmx|electric)$")
